...
class SketchField extends PureComponent {
  ...
  componentDidMount = () => {
    ...
    canvas.on("mouse:down", ({ e }) =>
      this.callEvent(canvas.getPointer(e), this._onMouseDown)
    );
    canvas.on("mouse:move", ({ e }) =>
      this.callEvent(canvas.getPointer(e), this._onMouseMove)
    );
    canvas.on("mouse:up", ({ e }) =>
      this.callEvent(canvas.getPointer(e), this._onMouseUp)
    );
    canvas.on("mouse:out", ({ e }) =>
      this.callEvent(canvas.getPointer(e), this._onMouseOut)
    );
